...
## 简介
`MineShop Vue` 是一个开源免费专门适配于 `MineShop` 后台权限管理系统的前端中后台模板，使用了 `vue3`, `vite4`, `pinia`, `arco design`, `javascript` 等主流开发技术，未使用`Typescript`，我们选择了简单。

在使用 MineShop Vue 前请认真阅读[《免责声明》](https://doc.mineadmin.com/guide/start/declaration.html)并同意该声明。
...
- UI库：arco design
- 国际化：完善的多语言解决方案
- 权限：由于适配 `MineShop` 系统，内置完善的权限、动/静态路由解决方案
- 主题：可扩展主题
- 布局：支持三种布局方式
- 组件：内置大量基于日常开发锤炼出的组件。
...
- 获取代码
```
git clone https://github.com/yangxmo/mine-shop-vue
```
或
```
git clone https://github.com/yangxmo/mine-shop-vue
...
## 免责声明
本软件不得用于开发违反国家有关政策的相关软件和应用，若因使用本软件造成的一切法律责任均与 `MineShop Vue` 无关

## 协议说明
`MineShop Vue` 遵循MIT开源协议发布，免费开源。

版权所有Copyright © 2020-2022 by MineShop (http://www.mineadmin.com)

All rights reserved。

## 通过OSCS安全认证

<a href="https://www.oscs1024.com/project/oscs/kanyxmo/MineShop-Vue?ref=badge_large" alt="OSCS Status"><img src="https://www.oscs1024.com/platform/badge/kanyxmo/MineShop-Vue.svg?size=large"/></a>
