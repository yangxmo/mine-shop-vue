...
<template>
  <div class="w-full lg:w-3/12 ma-content-block rounded-sm ml-0 lg:ml-3 p-3 mt-3">
    ...
    <div class="block lg:grid lg:grid-cols-2 lg:gap-1 mt-3">
      ...
      <a-card class="rounded-sm text-center mt-2" :body-style="{ padding: 0 }" :bordered="false">
        <a-button
          type="outline"
          class="w-4/5"
          @click="openPage('https://github.com/kanyxmo/MineShop')"
        >Github</a-button>
      </a-card>
      <a-card class="rounded-sm text-center mt-2" :body-style="{ padding: 0 }" :bordered="false">
        <a-button
          type="outline"
          class="w-4/5"
          @click="openPage('https://gitee.com/xmo/MineShop')"
        >Gitee </a-button>
      </a-card>
      <a-card class="rounded-sm text-center mt-2" :body-style="{ padding: 0 }" :bordered="false">
        <a-button
          type="outline"
          class="w-4/5"
          @click="openPage('https://gitee.com/xmo/MineShop/releases')"
        >更新日志</a-button>
      </a-card>
      <a-card class="rounded-sm text-center mt-2" :body-style="{ padding: 0 }" :bordered="false">
        <a-button
    ...
    <div class="w-11/12 mx-auto mt-3">
      <a-tag class="ml-0.5">MineShop v{{ config.version }} release</a-tag>
    </div>
  </div>
</template>
